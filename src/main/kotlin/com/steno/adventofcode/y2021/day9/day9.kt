package com.steno.adventofcode.y2021.day9
...
private fun main() {
    assignment("2021/day9") { lines -> HeightMap(lines.map { line -> line.map { it.digitToInt() } }.toList()) }
        .eval { heightMap -> heightMap.lowpoints.sumOf { it.riskLevel } }
        .eval { heightMap -> heightMap.lowpoints
